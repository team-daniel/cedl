...
class ClassificationEvaluator:
    ...
    def get_threshold(self):
        if self.threshold == Thresholds.DIFF_ENTROPY and not isinstance(self.model, (models.EvidentialModel, models.SmoothedEvidentialModel, models.InformationEvidentialModel, models.DensityAwareEvidentialModel, models.EvidentialPlusMetaModel, models.EvidentialPlusMcModel, models.ConflictingEvidentialMetaModel, models.ConflictingEvidentialMcModel, models.PosteriorModel)):
                raise RuntimeError("Differential Entropy threshold is only allowed for Evidential-based models.")
        
        if self.threshold == Thresholds.TOTAL_ALPHA and not isinstance(self.model, (models.EvidentialModel, models.SmoothedEvidentialModel, models.InformationEvidentialModel, models.DensityAwareEvidentialModel, models.EvidentialPlusMetaModel, models.EvidentialPlusMcModel, models.ConflictingEvidentialMetaModel, models.ConflictingEvidentialMcModel, models.PosteriorModel)):
